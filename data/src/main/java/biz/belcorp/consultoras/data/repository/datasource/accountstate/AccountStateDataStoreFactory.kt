...
import biz.belcorp.consultoras.data.net.service.impl.AccountStateService
 ...
 */
@Singleton
class AccountStateDataStoreFactory
/**
...
internal constructor(context: Context, private val sessionManager: ISessionManager) {
     ...
     */
    fun create(): AccountStateDataStore {
        return createDB()
    }
     ...
     */
    fun createDB(): AccountStateDataStore {
        return AccountStateDBDataStore(context)
    }
     ...
     */
    fun createCloudDataStore(): AccountStateDataStore {
        val service = AccountStateService(context, sessionManager.accessToken,
            sessionManager.appName, sessionManager.country)
        return AccountStateCloudDataStore(service)
    }
}
