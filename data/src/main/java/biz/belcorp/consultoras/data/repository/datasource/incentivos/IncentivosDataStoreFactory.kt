...
import biz.belcorp.consultoras.data.net.service.impl.IncentivosService
 ...
 */
@Singleton
class IncentivosDataStoreFactory
/**
...
internal constructor(context: Context, private val sessionManager: ISessionManager) {
     ...
     */
    fun create(): IncentivosDataStore {
        return createDB()
    }
     ...
     */
    fun createDB(): IncentivosDataStore {
        return IncentivosDBDataStore(context)
    }
     ...
     */
    fun createCloudDataStore(): IncentivosDataStore {
        val service = IncentivosService(context, sessionManager.accessToken,
                sessionManager.appName, sessionManager.country)
        return IncentivosCloudDataStore(service)
    }
}
