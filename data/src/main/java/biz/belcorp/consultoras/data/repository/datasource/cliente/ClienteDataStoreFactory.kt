...
import biz.belcorp.consultoras.data.net.service.impl.ClienteService

/**
 * Clase de Cliente encargada de procesar los datos desde un servicio o base de datos
...
internal constructor(context: Context, private val sessionManager: ISessionManager) {
     ...
     */
    fun createDB(): ClienteDataStore {
        return ClienteDBDataStore(context)
    }
     ...
     */
    fun createCloudDataStore(): ClienteDataStore {
        val service = ClienteService(context, sessionManager.accessToken,
                sessionManager.appName, sessionManager.country)
        return ClienteCloudDataStore(service)
    }
}
