...
import biz.belcorp.consultoras.data.net.service.impl.SyncDataService

/**
 * Clase de Sync encargada de procesar los datos desde un servicio o base de datos
...
internal constructor(context: Context, private val sessionManager: ISessionManager) {
     ...
     */
    fun createCloudDataStore(): SyncDataStore {
        val service = SyncDataService(context, sessionManager.accessToken,
                sessionManager.appName, sessionManager.country)
        return SyncCloudDataStore(service)
    }
     ...
     */
    fun createDB(): SyncDataStore {
        return SyncDBDataStore()
    }
