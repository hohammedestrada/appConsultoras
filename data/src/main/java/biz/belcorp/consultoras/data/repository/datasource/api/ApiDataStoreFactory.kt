...
internal constructor(context: Context, private val sessionManager: ISessionManager) {
     ...
     */
    fun createCloudDataStore(): ApiDataStore {
        val service = ApiService(context, BuildConfig.BASE_API, sessionManager.appName,
            sessionManager.country)
        return ApiCloudDataStore(service)
    }
     ...
     * @return class Clase que se encargara de obtener los datos desde el Servicio
     */
    fun createDB(): ApiDataStore {
        return ApiDBDataStore(context)
    }
}
