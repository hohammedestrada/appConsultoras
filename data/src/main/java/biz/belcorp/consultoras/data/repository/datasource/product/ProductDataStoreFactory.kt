...
import biz.belcorp.consultoras.data.net.service.impl.ProductService

/**
 * Clase de Product encargada de procesar los datos desde un servicio o base de datos
...
internal constructor(context: Context, private val sessionManager: ISessionManager) {
     ...
     */
    fun createDB(): ProductDataStore {
        return ProductDBDataStore(context)
    }
    ...
    fun createCloudDataStore(): ProductDataStore {
        val service = ProductService(context, sessionManager.accessToken,
                sessionManager.appName, sessionManager.country)
        return ProductCloudDataStore(service)
    }
}
