...
object RestApi {
    ...
    fun <S> create(clazz: Class<S>, url: String?, accessToken: AccessToken?, oAccessToken: String?, appName: String?, appCountry: String?): S {
        return belcorpApi.create(clazz, url, accessToken, oAccessToken, appName, appCountry)
    }
