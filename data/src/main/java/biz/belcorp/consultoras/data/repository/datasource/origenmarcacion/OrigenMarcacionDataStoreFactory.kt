 ...
 */
@Singleton
class OrigenMarcacionDataStoreFactory
/**
...
internal constructor(context: Context, private val sessionManager: ISessionManager) {
     ...
     */
    fun create(): OrigenMarcacionDataStore {
        return createDB()
    }
     ...
     */
    fun createDB(): OrigenMarcacionDataStore {
        return OrigenMarcacionDBDataStore(context)
    }
}
