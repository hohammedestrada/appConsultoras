...
/**
 * Clase de Pais encargada de procesar los datos desde un servicio o base de datos
...
internal constructor(context: Context) {
     ...
     */
    fun createDB(): CountryDataStore {
        return CountryDBDataStore(context)
    }
     ...
     */
    fun createCloudDataStore(): CountryDataStore? {
        return null
    }
