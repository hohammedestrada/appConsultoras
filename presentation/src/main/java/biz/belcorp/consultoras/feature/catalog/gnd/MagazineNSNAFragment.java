package biz.belcorp.consultoras.feature.catalog.gnd;
 ...
 *
 */
public class MagazineNSNAFragment extends BaseFragment {
    ...
    public static MagazineNSNAFragment newInstance() {
        return new MagazineNSNAFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_magazine_gnd, container, false);
    ...
    public void encuentralasAqui() {
        ...
        if (null != eventListener && null != magazine.getMagazineEntity()) {
            eventListener.trackEvent(
                ...
                GlobalConstant.EVENT_ACTION_OFERTAS_NSNA,
        ...
        intent.putExtra(OffersActivity.OPTION, PageUrlType.GUIA_NEGOCIO);
    ...
    public void showMagazine() {
        ...
        // Open PedidosPendientesActivity
