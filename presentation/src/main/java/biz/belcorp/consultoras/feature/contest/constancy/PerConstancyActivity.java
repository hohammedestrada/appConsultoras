...
import biz.belcorp.consultoras.feature.contest.constancy.di.DaggerPerConstancyComponent;
...
public class PerConstancyActivity extends BaseActivity implements
    HasComponent<PerConstancyComponent>, LoadingView {

    private PerConstancyComponent component;
    ...
    private PerConstancyFragment fragment;

    /**********************************************************/

    public static Intent getCallingIntent(Context context) {
        return new Intent(context, PerConstancyActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contest_per_constancy);
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            fragment = new PerConstancyFragment();
            fragment.setArguments(getIntent().getExtras());
            addFragment(R.id.fltContainer, fragment);
        }

        String campaign = getIntent().getExtras().getString(GlobalConstant.CODE_CAMPAIGN, "");
        String countryISO = getIntent().getExtras().getString(GlobalConstant.TRACK_VAR_COUNTRY,"");
        String title = getString(R.string.incentives_title_constancia_activity);
        if(Country.PE.equals(countryISO)){
            title = getString(R.string.bonificaciones_title_constancia_activity);
        }
        tvwToolbar.setText(title + " " + campaign);

        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setNavigationOnClickListener(v -> {
            if (fragment != null) onBackPressed();
        });
        TextView tvwToolbarTitle = toolbar.findViewById(R.id.tvw_toolbar_title);
        tvwToolbarTitle.setText(title + " " + campaign);
    }

    @Override
    protected void initializeInjector() {
        this.component = DaggerPerConstancyComponent.builder()
    ...
    @Override
    public PerConstancyComponent getComponent() {
        return component;
    }
