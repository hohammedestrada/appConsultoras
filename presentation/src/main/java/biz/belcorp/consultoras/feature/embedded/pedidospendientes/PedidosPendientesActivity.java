...
import biz.belcorp.consultoras.feature.embedded.pedidospendientes.di.DaggerPedidosPendientesComponent;
...
public class PedidosPendientesActivity extends BaseActivity
    implements HasComponent<PedidosPendientesComponent>,
    PedidosPendientesFragment.Listener, LoadingView {

    public static final String OPTION = "opcion";

    public static final int RESULT = 1080;

    private PedidosPendientesComponent component;
    ...
    private PedidosPendientesFragment fragment;
    private MenuItem searchItem;

    /**********************************************************/

    public static Intent getCallingIntent(Context context) {
        return new Intent(context, PedidosPendientesActivity.class);
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            fragment = new PedidosPendientesFragment();
    ...
    protected void initializeInjector() {
        this.component = DaggerPedidosPendientesComponent.builder()
    ...
    @Override
    public PedidosPendientesComponent getComponent() {
        return component;
    }
