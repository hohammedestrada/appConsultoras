package biz.belcorp.consultoras.feature.dreammeter.component.snow
...
class Snowflake(val params: Params) {
    ...
    fun draw(canvas: Canvas) {
        bitmap?.let {
            canvas.drawBitmap(it, positionX.toFloat(), positionY.toFloat(), paint)
        } ?: run {
