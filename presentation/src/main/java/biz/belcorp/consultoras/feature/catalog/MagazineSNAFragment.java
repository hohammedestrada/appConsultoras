 ...
 *
 */
public class MagazineSNAFragment extends BaseFragment {
    ...
    public static MagazineSNAFragment newInstance() {
        return new MagazineSNAFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_magazine_suscrita_no_activa, container, false);
    ...
    public void encuentralasAqui() {
        ...
        if (null != eventListener && null != magazine.getMagazineEntity()) {
            eventListener.trackEvent(
                ...
                GlobalConstant.EVENT_ACTION_OFERTAS_SNA,
