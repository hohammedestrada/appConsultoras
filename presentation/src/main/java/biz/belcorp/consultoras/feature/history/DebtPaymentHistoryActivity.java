...
public class DebtPaymentHistoryActivity extends BaseActivity implements HasComponent<ClientComponent>
    , LoadingView {
    ...
    private DebtPaymentHistoryFragment fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_debt_payment_history);
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            fragment = new DebtPaymentHistoryFragment();
    ...
    private void initializeToolbar() {
        ...
        tvwToolbarTitle.setText(getString(R.string.debt_history_toolbar_title));
