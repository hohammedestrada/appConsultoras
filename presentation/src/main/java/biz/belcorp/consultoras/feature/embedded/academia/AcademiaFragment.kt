...
class AcademiaFragment : BaseFragment(), AcademiaOrderView {

    @Inject
    lateinit var presenter: AcademiaPresenter
    ...
    override fun onInjectView(): Boolean {
        getComponent(AcademiaComponent::class.java).inject(this)
        return true
    }
    ...
    override fun onViewInjected(savedInstanceState: Bundle?) {
        ...
        presenter.getPageTitle(MenuCode.ACADEMIA)
        presenter.getUrl()
    }
    ...
    override fun initScreenTrack(model: LoginModel) {
        Tracker.trackScreen(GlobalConstant.SCREEN_MY_ACADEMY, model)
    }


    override fun trackBack(model: LoginModel) {
        Tracker.trackBackEvent(GlobalConstant.SCREEN_MY_ACADEMY, model)
    ...
    override fun showUrl(url: String) {
        ...
        headers["app_belcorp"] = "1"


        when {
            getNivelCaminoBrillante().isEmpty() -> webView.loadUrl(url, headers)
            else -> {
                val newUrl = "$url&course=${getNivelCaminoBrillante()}"
    ...
    private fun getNivelCaminoBrillante(): String {
        return arguments?.getString(ARGS_NIVEL) ?: ""
    }
    ...
    /*
    companion object {
        fun newInstance(): AcademiaFragment {
    ...
    */
    ...
    companion object {
        ...
        fun newInstance(nivel: String): AcademiaFragment {
            return AcademiaFragment().apply {
