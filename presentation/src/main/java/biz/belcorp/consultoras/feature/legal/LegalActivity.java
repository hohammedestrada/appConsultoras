...
import biz.belcorp.consultoras.feature.legal.di.DaggerLegalComponent;
...
public class LegalActivity extends BaseActivity implements HasComponent<LegalComponent>,
    LoadingView, LegalFragment.OnLegalListener {
    ...
    private LegalFragment fragment;
    ...
    protected void initializeInjector() {
        this.component = DaggerLegalComponent.builder()
    ...
    private void initializeToolbar() {
        tvwToolbar.setText(getString(R.string.legal_title));
