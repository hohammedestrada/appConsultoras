 ...
 *
 */
public class ClientEditActivity extends BaseActivity implements HasComponent<ClientComponent>,
    LoadingView, ClientEditFragment.ClientEditFragmentListener {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            fragment = new ClientEditFragment();
    ...
    public void onChange(int result) {
        ...
        resultIntent.putExtra("change", result);
