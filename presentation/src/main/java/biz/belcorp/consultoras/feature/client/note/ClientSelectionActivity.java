...
public class ClientSelectionActivity extends BaseActivity implements HasComponent<DebtComponent>, ClientFilterFragment.OnFilterCompleteListener, LoadingView {
    ...
    private DebtComponent component;
    ...
    public void onSyncEvent(SyncEvent event) {
        BelcorpLogger.d("ClientSelectionActivity onSyncEvent " + event.isSync(),"");
        if (event.isSync()) {
    ...
    protected void init(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.container, clientFilterFragment).commit();
        }
    }

    @Override
    protected void initializeInjector() {
        component = DaggerDebtComponent.builder()
    ...
    @Override
    public void onComplete(ClienteModel clientModel) {
