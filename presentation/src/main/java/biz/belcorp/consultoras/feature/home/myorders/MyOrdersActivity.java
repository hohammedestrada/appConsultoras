...
public class MyOrdersActivity extends BaseActivity implements HasComponent<ClientComponent>,
    LoadingView, MyOrdersFragment.Listener {
    ...
    public void goToAddOrders() {
        Intent intent = new Intent(this, AddOrdersActivity.class);
    ...
    private void initializeToolbar() {
        ...
        tvwToolbarTitle.setText(getString(R.string.my_orders_title));
