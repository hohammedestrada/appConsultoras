...
public class SendPaymentActivity extends BaseActivity implements HasComponent<ClientComponent>
    , SendPaymentFragment.SendPaymentListener, LoadingView {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            fragment = new SendPaymentFragment();
    ...
    private void initializeToolbar() {
        ...
        tvwToolbarTitle.setText(getString(R.string.send_payment_toolbar_title));
