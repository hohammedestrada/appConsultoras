...
public class AccountStateActivity extends BaseActivity implements HasComponent<ClientComponent>, LoadingView,AccountStateFragment.AccountStateFragmentListener {
    ...
    private AccountStateFragment fragment;
    /**********************************************************/
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            fragment = new AccountStateFragment();
    ...
    private void initializeToolbar() {
        ...
        tvwToolbarTitle.setText(getString(R.string.my_business_info_title));
