...
class SubCampaingErrorFragment : BaseHomeFragment() {
    ...
    fun showMessage(type: Int?){
        when(type){
            ...
            ERROR_MESSAGE_EMPTY_SUBCAMPAIGN -> {
                txtTitle.text = resources.getString(R.string.subcampaign_empty_product)
                txtSubtitle.visibility = View.GONE
                imgEmpty.setImageResource(R.drawable.negative_notification)
                btnRefresh.visibility = View.GONE
            }
     ...
     */
    companion object {
        val TAG: String = SubCampaingErrorFragment::class.java.simpleName
        ...
        const val ERROR_MESSAGE_EMPTY_SUBCAMPAIGN = 7

        fun newInstance(): SubCampaingErrorFragment {
            return SubCampaingErrorFragment()
        }
    }
