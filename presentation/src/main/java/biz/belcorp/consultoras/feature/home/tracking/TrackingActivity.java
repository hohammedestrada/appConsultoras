...
import biz.belcorp.consultoras.feature.home.tracking.di.DaggerTrackingComponent;
...
public class TrackingActivity extends BaseActivity implements HasComponent<TrackingComponent>, LoadingView {
    ...
    public static final Integer TRACKING_TOP_3 = 3;
    ...
    protected void initializeInjector() {
        this.component = DaggerTrackingComponent.builder()
    ...
    private void initializeToolbar() {
        ...
        tvwToolbarTitle.setText(getString(R.string.tracking_title                                                                                               ));
