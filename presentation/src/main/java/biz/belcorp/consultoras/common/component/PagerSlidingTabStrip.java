...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private TrackPageEventClick trackPageEventClick;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        // getIncentives system attrs (android:textSize and android:textColor)
    ...
    public void setTrackPageEventClick(TrackPageEventClick trackPageEventClick) {
        this.trackPageEventClick = trackPageEventClick;
    }
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(v -> {
            if (trackPageEventClick != null)
                trackPageEventClick.trackEvent(pager.getCurrentItem());
    ...
    private void updateTabStyles(final int position) {
    ...
    protected void onAttachedToWindow() {
        try {
            ...
            BelcorpLogger.w("onAttachedToWindow", e);
            if (activityContainer == null)
                activityContainer = getRequiredActivity();

            if (activityContainer != null)
                activityContainer.recreate();
        }
    }

    private Activity getRequiredActivity() {
    ...
    public interface TrackPageEventClick {
        void trackEvent(int page);
    }
}
