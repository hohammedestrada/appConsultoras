...
public class PromptUtils
{
     ...
     *
     * @param x            The controlAnimation position in the view.
     * @param y            The y position in the view.
     * @param circleCentre The circle centre position
     * @param radius       The radius of the circle.
     * @return True if the point (controlAnimation, y) is in the circle.
     */
     ...
     */
    static Typeface setTypefaceFromAttrs(String familyName, int typefaceIndex, int styleIndex)
    {
        Typeface tf = null;
        if (familyName != null)
        {
    ...
    static Layout.Alignment getTextAlignment(final Resources resources, final int gravity,
     ...
     */
    static StaticLayout createStaticTextLayout(final CharSequence text,
     ...
     */
    static boolean isRtlText(final Layout layout, final Resources resources)
    {
     ...
     */
    static float calculateMaxWidth(final float maxTextWidth, @Nullable final Rect clipBounds, final int parentWidth, final float textPadding)
    {
     ...
     */
    static float calculateMaxTextWidth(final Layout textLayout)
    {
     ...
     * @param x The point controlAnimation coordinate.
     * @param y The point y coordinate.
     * @return True if the point is within the inset rectangle, false otherwise.
     */
    static boolean containsInset(final Rect bounds, final int inset, final int x, final int y)
    {
